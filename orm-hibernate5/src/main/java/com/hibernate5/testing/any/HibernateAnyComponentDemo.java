...
public class HibernateAnyComponentDemo {
    ...
    private static void testSaveObjects(Session session) {
        ...
        Component component = new Component("name test", 100.0);
        ClassModel2 classModel2 = new ClassModel2(2.0, "name model 2");
        session.persist(classModel2);

        MyAnyClass myAnyClass = new MyAnyClass(2, "name new", classModel2, component);
