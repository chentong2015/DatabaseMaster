...
import hibernate.metadata.source.config.MyDialectResolver;
import hibernate.metadata.source.config.MyPhysicalNamingStrategy;
import hibernate.metadata.source.entity.BaseJpaMetadata;
