...
import entity.join.fetching.Department;
import entity.join.fetching.Employee;
...
public class DemoJoinFetching {
    ...
    public static void testFetching(Session session) {
    ...
    public static void testSelectFetchMode(Session session) {
        String hqlQuery = "from entity.join.fetching.Department";
    ...
    public static void testSubSelectFetchMode(Session session) {
        String hqlQuery = "select d from entity.join.fetching.Department d where d.name like :token";
