...
public class SchemaImportExportTester {
    ...
    private static String sqlServerRemote = "jdbc:sqlserver://server:1433;Database=DAS_CONV_TOOL;Trusted_Connection=true;useBulkCopyForBatchInsert=true;";
    private static String oracleRemote = "jdbc:oracle:thin:@//server:1521/DB_NAME";
