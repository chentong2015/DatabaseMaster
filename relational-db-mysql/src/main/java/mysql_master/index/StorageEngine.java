...
// 存储引擎则是小而精, 纯粹专注于单机的读/写/存储 ===> 形容数据库表的 !!
public class StorageEngine {
    ...
    // TODO: "Innodb_page_size" 页的设计作用 ?
    // Page(C语言实现)是InnoDB在存储数据的最小基本单位, 默认是16KB，是磁盘读交互(I/O)的数据单位量，用page是为了减少IO的次数，提升性能
    // 操作系统中的页Page(C语言实现)，持久化的最小单位是4b

    // InnoDB如何使用Page页(16KB)来存储数据 ?
    // 页目录(索引)  在用户数据区域
